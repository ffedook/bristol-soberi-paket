          ...
          <Dialog title="Защити свой пакет" onClose={closeModal}>
            ...
            <div className="booster-explanation safe">
              ...
              <div>
                ...
                <p>
                  Защищает от всех краж 3 секунды. Пока идёт таймер, белка не
        ...
        {modal === 'rules' && (
          <Dialog title="Ещё тап или забрать?" onClose={closeModal}>
            ...
            <p className="small-copy">
              ...
              безопасная зона защищает 3 секунды. Каждый можно купить до трёх
            ...
            <div className="rules-economy">
              ...
              <p>
                Риск без бустеров растёт с 2,62% до 15,32% за нажатие. Исход
                фиксируется при нажатии; анимация показывает уже определённый
                результат.
              </p>
            </div>
            <p className="small-copy">
